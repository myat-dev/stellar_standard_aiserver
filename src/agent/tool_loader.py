...
class ToolLoader:
    def __init__(
        ...
        self.button_tool_map: Dict[str, List[str]] = {
            "button_1": ["call_person", "weather_info", "train_info", "information"],
            "button_2": ["call_person"],
            "button_3": ["call_person"],
            "button_4": ["call_person"],
            "button_5": ["delivery"],
            "button_dengon": ["dengon"],
        }
    ...
    def get_tools_by_keys(self, tool_keys: List[str]) -> List[Any]:
        ...
        return [self.tool_factories[key]() for key in tool_keys if key in self.tool_factories]
